...
###################### CTW-1500 ####################################
# test_size=(640,1024)--cfglib/option
CUDA_LAUNCH_BLOCKING=1 python eval_textBPN.py --exp_name Ctw1500 --checkepoch 70 --dis_threshold 0.3 --cls_threshold 0.8 --test_size 640 1024 --gpu 0 --image_dir ./ --output_dir ./

...
class BaseOptions(object):
    ...
    def __init__(self):
        ...
        self.parser.add_argument('--display_freq', default=5, type=int, help='display training metrics every # iter')
        ...
        self.parser.add_argument('--image_dir', type=str, required=True, help='Directory containing the input images')
        self.parser.add_argument('--output_dir', type=str, required=True, help='Directory to save the output results')
        # self.parser.add_argument('--visual_dir', type=str, required=True, help='Directory to save the visualization results')

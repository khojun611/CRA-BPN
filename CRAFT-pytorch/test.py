...
parser.add_argument('--test_folder', default='../TextBPN/data/ctw1500/test/text_image/', type=str, help='folder path to input images')
...
result_folder = './TextBPN/ctw_test_coord/'
print("result folder", result_folder)
# result_folder = '../TextBPN/ctw_train_coord/'
